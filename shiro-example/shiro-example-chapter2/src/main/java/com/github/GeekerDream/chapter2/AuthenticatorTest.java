...
public class AuthenticatorTest {
	...
	private Subject getSubject(String configFile) {
	...
	private UsernamePasswordToken getToken() {
		return new UsernamePasswordToken("chen", "123");
	}
	
	private void login(String configFile) {
		Subject subject = getSubject(configFile);
		subject.login(getToken());
	}
